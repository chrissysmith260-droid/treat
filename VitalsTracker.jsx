...
const VitalsTracker = ({ onLogVitals }) => {
  ...
  return (
    <div style={{ background: '#CCE5FF', padding: '20px', borderRadius: '20px', boxShadow: '0 4px 6px rgba(0,0,0,0.05)' }}>
      <h3 style={{ color: theme.colors.accentBlue }}>Daily Vitals</h3>
      <div style={{ display: 'grid', gap: '10px' }}>
        <input type="number" name="o2" placeholder="Oxygen %" onChange={handleChange} style={inputStyle} />
        <input type="number" name="hr" placeholder="Heart Rate (BPM)" onChange={handleChange} style={inputStyle} />
        <input type="text" name="bp" placeholder="Blood Pressure (e.g. 120/80)" onChange={handleChange} style={inputStyle} />
        <input type="number" name="glucose" placeholder="Glucose (mg/dL)" onChange={handleChange} style={inputStyle} />
      </div>
      ...
      {suggestion && (
        <div style={{ marginTop: '15px', padding: '15px', backgroundColor: '#B3D7FF', borderRadius: '10px', borderLeft: `5px solid ${theme.colors.leafGreen}` }}>
      ...
      <div style={{ marginTop: '20px', textAlign: 'center' }}>
        ...
        <a 
          ...
          style={{ textDecoration: 'none', color: 'white', textShadow: '1px 1px 0 #000, -1px 1px 0 #000, 1px -1px 0 #000, -1px -1px 0 #000', backgroundColor: '#81C784', padding: '10px 20px', borderRadius: '20px', display: 'inline-block' }}
        >
