...
const SuccessPage = () => {
  return (
    <div style={{ 
      ...
      <div style={{ backgroundColor: '#CCE5FF', padding: '40px', borderRadius: theme.borderRadius, boxShadow: '0 4px 12px rgba(0,0,0,0.1)' }}>
        ...
        >
          <ArrowLeft size={18} style={{ filter: 'drop-shadow(1px 1px 0 #000) drop-shadow(-1px 1px 0 #000) drop-shadow(1px -1px 0 #000) drop-shadow(-1px -1px 0 #000)' }} /> Return to App
        </button>
      </div>
    </div>
  );
